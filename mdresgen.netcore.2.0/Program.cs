...
namespace mdresgen
{
    class Program
    {
        ...
        // Legacy
        private const string OldXamlFileFormat = @"..\..\..\MaterialDesignColors.Avalonia\Themes\MaterialDesignColor.{0}.xaml";
        private const string OldXamlNamedFileFormat = @"..\..\..\MaterialDesignColors.Avalonia\Themes\MaterialDesignColor.{0}.Named.xaml";


        private const string XamlPrimaryFileFormat = @"..\..\..\MaterialDesignColors.Avalonia\Themes\MaterialDesignColor.{0}.Primary.xaml";
        private const string XamlAccentFileFormat = @"..\..\..\MaterialDesignColors.Avalonia\Themes\MaterialDesignColor.{0}.Accent.xaml";
        private const string XamlPrimaryNamedFileFormat = @"..\..\..\MaterialDesignColors.Avalonia\Themes\MaterialDesignColor.{0}.Named.Primary.xaml";
        private const string XamlAccentNamedFileFormat = @"..\..\..\MaterialDesignColors.Avalonia\Themes\MaterialDesignColor.{0}.Named.Accent.xaml";

        private const string RecommendedPrimaryFileFormat = @"..\..\..\MaterialDesignColors.Avalonia\Themes\Recommended\Primary\MaterialDesignColor.{0}.xaml";
        private const string RecommendedAccentFileFormat = @"..\..\..\MaterialDesignColors.Avalonia\Themes\Recommended\Accent\MaterialDesignColor.{0}.xaml";
